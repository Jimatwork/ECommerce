...
import com.kubian.rpc.JsonRpcNotificationService;
import com.kubian.rpc.JsonRpcUserControl;
import com.kubian.rpc.ParticipantSession;
  ...
  public final void handleRequest(Transaction transaction, Request<JsonObject> request)
    ...
    switch (request.getMethod()) {
      ...
      case ProtocolElements.CUSTOMREQUEST_METHOD :
        userControl.customRequest(transaction, request, participantRequest,notificationService);
        break;
      default :
