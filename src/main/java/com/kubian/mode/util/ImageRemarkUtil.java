...
/**
 * 图片水印工具 ClassName: ImageRemarkUtil
 * 
 * @Description: TODO
 * @author HD
 * @date 2018年6月1日
...
public class ImageRemarkUtil {
	 ...
	 *            目标图片路径
	 */
	public static void markImageByIcon1(String iconPath, String srcImgPath, String targerPath) {
		markImageByIcon1(iconPath, srcImgPath, targerPath, null);
	}

	/**
	 * 给图片左上角添加水印图片、可设置水印图片旋转角度
	 * 
	 * @param iconPath
	 *            水印图片路径
	 * @param srcImgPath
	...
	public static void markImageByIcon(String iconPath, String srcImgPath, String targerPath, Integer degree) {
		...
		try {
			...
			Image srcImg2 = ImageIO.read(srcImgFile);// 文件转化为图片
			int srcImgWidth = srcImg2.getWidth(null);// 获取图片的宽
			int srcImgHeight = srcImg2.getHeight(null);// 获取图片的高
			System.out.println("图片宽：" + srcImgWidth + "图片高：" + srcImgHeight);
			int imgWidth = srcImgWidth;
			int imgHeight = srcImgHeight;
	 ...
	 *            水印图片旋转角度
	 */
	public static void markImageByIcon1(String iconPath, String srcImgPath, String targerPath, Integer degree) {
		OutputStream os = null;
		try {
			...
			File srcImgFile = new File(srcImgPath);// 得到文件
			Image srcImg2 = ImageIO.read(srcImgFile);// 文件转化为图片
			int srcImgWidth = srcImg2.getWidth(null);// 获取源图片的宽
			int srcImgHeight = srcImg2.getHeight(null);// 获取源图片的高

			File srcImgFile1 = new File(iconPath);// 得到文件
			Image srcImg1 = ImageIO.read(srcImgFile1);// 文件转化为图片
			int sImgWidth = srcImg1.getWidth(null);// 获取水印图片的宽
			int sImgHeight = srcImg1.getHeight(null);// 获取水图片的高
			System.out.println("图片宽：" + srcImgWidth + "图片高：" + srcImgHeight);
			int imgWidth = srcImgWidth;
			int imgHeight = srcImgHeight;
			System.out.println("水印图片宽：" + srcImgWidth + "水印图片高：" + srcImgHeight);
			g.drawImage(img, imgWidth - 10 - sImgWidth, imgHeight - 10 - sImgHeight, null);
			g.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER));
			// 7、释放资源
			g.dispose();
	...
	public static void main(String[] args) {
		...
		String srcImgPath = "C:/Users/Administrator/Desktop/mu/qihang.png";
		String targerIconPath = "C:/Users/Administrator/Desktop/mu/3.jpg";
		// String targerIconPath2 =
		// "C:/Users/Administrator/Desktop/mu/1234.jpg";
		// 给图片添加水印图片
