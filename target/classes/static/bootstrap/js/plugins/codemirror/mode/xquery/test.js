...
(function() {
  ...
  MT("eviltest",
     ...
     "      [keyword return] [keyword element] [variable element] {",
     "          [keyword attribute] [variable attribute] { [keyword try] { [def&variable xdmp:version]() } [keyword catch]([variable $test]) { [def&variable xdmp:log]([variable $test]) } },",
  ...
  MT("test namespaced variable",
     "[keyword declare] [keyword namespace] [variable test] [keyword =] [string \"http://example.com/ANamespace\"][variable ;declare] [keyword variable] [variable $test:exampleComThisVarIsNotRecognized] [keyword as] [keyword element]([keyword *]) [variable external;]");
