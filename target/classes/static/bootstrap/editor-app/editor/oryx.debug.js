 ...
 * test.g. http://www.example.org/stencilset#ANode
 */
...
ORYX.Plugins.AbstractPlugin = Clazz.extend({
    ...
    */
    ...
    /**
       ...
       @methodOf ORYX.Plugins.AbstractPlugin.prototype
       @param {String} data The data (test.g. eRDF) which should be transformed
...
//    },
    ...
    getAllShapesToConsider: function(shapes){
        ...
        shapes.each(function(shape){
            ...
            // Consider attached nodes (test.g. intermediate events)
 ...
 * the user from accidently unloading the page by, test.g., pressing the backspace
...
new function(){
	...
	ORYX.Plugins.Layouter.EdgeLayouter = ORYX.Plugins.AbstractLayouter.extend({
		 ...
		 * @param {Object} edge Edge between from and to
		 * @param {Boolean} reverse Reverse the direction (test.g. "r" -> "l")
		 */
